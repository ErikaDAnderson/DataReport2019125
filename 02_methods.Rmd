...
## OCEANOGRAPHY
A standalone [Sea-bird](https://www.seabird.com/) 25 CTD (conductivity-temperature-depth) was used for water profiles (Sea-bird Electronics Bellevue Washington, USA) at `r nrow(ctdSimp)` stations (Figure \@ref(fig:mapctd)). A Niskin bottle at 10 m from the surface was used for chlorophyll (chl a) and nutrient collections. Seawater samples for nitrate, phosphate, and silicate were placed in acid-washed glass test tubes and frozen. Seawater for chl a estimation were filtered with GF/F glass fibre filter disks. Filter disks were then placed in polypropylene scintillation vials and frozen. Both the chlorophyll and nutrient samples were frozen and maintained at -18&deg;C. Seawater and chl a samples were sent for analyses at the Institute of Ocean Sciences, Fisheries and Oceans Canada (Sidney, BC). 
...
## ACOUSTIC DATA
Acoustic data was collected throughout the survey using the vessel [SIMRAD](https://www.kongsberg.com/maritime/products/commercial-fisheries/echo-sounders/) ES60 echo sounder.
