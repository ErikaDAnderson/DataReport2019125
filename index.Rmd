...
ocean <- rbind(ctd_simp, plankton_simp)
...
bridgetow <- tows %>%
  ...
  select(EVENT, Date, STATION, GEAR, START_TIME_hm, DURATION, START_LAT_DMS, START_LONG_DMS, END_LAT_DMS, END_LONG_DMS, HEADING, SPEED_KM, DISTANCE_KM, NET_OPENING_WIDTH, NET_OPENING_HEIGHT, WARP, TARGET_DEPTH, START_BOT_DEPTH, END_BOT_DEPTH, Usable) %>%
...
# recommend start lat/long and end lat/long also
...
ocean_comp <- ctd_orig %>%
  ...
  select(DATE_PT, STATION, CTD_LAT, CTD_LONG, CTD_START_TIME_hm, BOTTOM_DEPTH, CTD_DEPTH, BONGO_LAT, BONGO_LONG, BONGO_START_TIME_hm, BOT_DEPTH, BONGO_DEPTH)
