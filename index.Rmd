...
surveyDateRange <- "September 30 to October 15, 2019"
...
minLat <- min(tows$START_LAT)
maxLat <- max(tows$START_LAT) 
minLon <- min(tows$START_LONG)
maxLon <- max(tows$START_LONG)
