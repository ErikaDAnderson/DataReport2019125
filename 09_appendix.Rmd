...
(ref:coastalnet) Net specifications (side view) for the coastal LFS 7742 trawl net the `r surveyName` from `r surveyDateRange` on the *`r vessel`*.
...
csas_table(
  ...
  format = "latex", landscape = TRUE, font_size = 10,
